      ...
      <ContentSection title="Contact channels">
        <div className="grid gap-4 md:grid-cols-3">
          <div className="rounded-[24px] border border-white/10 bg-white/5 p-5">
            <p className="text-xs uppercase tracking-[0.22em] text-orange-300">Email</p>
            <p className="mt-3 text-lg font-medium text-white">hello@kejasafe.co.ke</p>
          </div>
          <div className="rounded-[24px] border border-white/10 bg-white/5 p-5">
            <p className="text-xs uppercase tracking-[0.22em] text-orange-300">Support</p>
            <p className="mt-3 text-lg font-medium text-white">support@kejasafe.co.ke</p>
          </div>
          <div className="rounded-[24px] border border-white/10 bg-white/5 p-5">
            <p className="text-xs uppercase tracking-[0.22em] text-orange-300">Location</p>
