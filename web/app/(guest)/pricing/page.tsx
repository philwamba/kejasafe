            ...
            <ContentSection title="Illustrative plan tiers">
                <div className="grid gap-4 lg:grid-cols-3">
                    {[
                        [
                            'Starter',
                            'For independent landlords onboarding a few verified listings.',
                        ],
                        [
                            'Growth',
                            'For agents and managers handling active portfolios and lead flow.',
                        ],
                        [
                            'Enterprise',
                            'For larger operational teams, custom processes, and reporting.',
                        ],
                    ].map(([name, copy]) => (
                        <article
                            key={name}
                            className="rounded-2xl border border-stone-200 bg-white p-6">
                            <p className="text-brand text-xs tracking-[0.24em] uppercase">
                                {name}
                            </p>
