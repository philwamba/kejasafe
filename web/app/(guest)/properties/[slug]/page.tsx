        ...
        <div className="space-y-6">
          <div className="space-y-4">
            <div className="flex flex-wrap items-center gap-3">
              <span className="rounded-full bg-brand/10 px-3 py-1 text-xs font-medium uppercase tracking-[0.22em] text-brand">
          ...
          <section className="rounded-2xl border border-stone-200 bg-white p-6">
            <h2 className="text-2xl font-semibold tracking-tight text-stone-950">Overview</h2>
            ...
            <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
              {property.amenities.length > 0 ? (
                property.amenities.map((amenity) => (
                  ...
                  >
                    <FiCheckCircle className="size-4 text-brand" />
                    {amenity}
                  </div>
                ))
              ) : (
                <>
                  <div className="inline-flex items-center gap-3 rounded-xl border border-stone-200 bg-stone-50 px-4 py-3 text-sm font-medium text-stone-800">
                    <FiShield className="size-4 text-brand" />
                    Secure entry workflow ready
                  </div>
                  <div className="inline-flex items-center gap-3 rounded-xl border border-stone-200 bg-stone-50 px-4 py-3 text-sm font-medium text-stone-800">
                    <FiWifi className="size-4 text-brand" />
          ...
          <div className="rounded-2xl border border-stone-200 bg-white p-6">
            ...
            <dl className="mt-5 grid gap-4 text-sm text-stone-800">
              ...
              <div className="flex items-center justify-between gap-3 border-b border-stone-200 pb-3">
                ...
                <dd className="capitalize">{property.county}</dd>
              </div>
