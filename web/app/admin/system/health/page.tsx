        ...
        <main className="mx-auto max-w-6xl px-6 py-10">
            <section className="rounded-3xl border border-white/10 bg-white/5 p-8">
                ...
                <p className="mt-3 max-w-2xl text-sm leading-7 text-zinc-300">
                    This page compares the live health status of both backend
                    modes from the Next control layer. It is the operational
                    surface that should expand into queues, mail, storage, and
                    sync diagnostics later.
                </p>
