...
function buildSearchInput(request: NextRequest): PropertySearchInput {
  ...
  return {
    ...
    listingPurpose: readStringParam(params, "listingPurpose") as PropertySearchInput["listingPurpose"],
    ...
    sortBy: readStringParam(params, "sortBy") as PropertySearchInput["sortBy"],
  };
}
