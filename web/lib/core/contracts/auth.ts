...
export interface AuthProvider {
  ...
  register(input: RegisterInput, ctx: RequestContext): Promise<AuthMutationResult>;
  ...
  resetPassword(input: PasswordResetInput, ctx: RequestContext): Promise<MessageResult>;
  requestEmailVerification(ctx: AuthContext): Promise<MessageResult>;
  verifyEmail(input: VerifyEmailInput, ctx: RequestContext): Promise<MessageResult>;
}
