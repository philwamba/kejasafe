import type { AuthContext, PaginatedResult, RequestContext } from "@/lib/core/contracts/common";
...
export interface PropertyProviderContract {
  ...
  getBySlug(slug: string, ctx: RequestContext): Promise<PropertyDetailDto | null>;
  create(input: CreatePropertyInput, ctx: AuthContext): Promise<PropertyDetailDto>;
}
