...
export const faqItems: FaqItem[] = [
  {
    ...
    answer:
      "Kejasafe is a housing and property operations platform designed to support listing discovery, tenant workflows, landlord operations, and admin moderation through a modern dual-backend architecture.",
  },
  {
    question: "Can listings come from different backends?",
    answer:
      "Yes. The frontend consumes normalized internal APIs and provider contracts, so the public site can resolve data from Prisma or Laravel without scattering backend-specific logic through components.",
  },
  {
    question: "Will Kejasafe support both rentals and sales?",
    answer:
      "Yes. The listing model already supports rent, sale, and short-stay inventory, with room for pricing history, moderation, media, and occupancy workflows.",
  },
  {
    question: "Does the platform support Kenyan locations properly?",
    answer:
      "Yes. The data model supports counties, cities, and neighborhoods so search, location landing pages, and future SEO pages can be structured in a way that fits the Kenyan market.",
  },
];
